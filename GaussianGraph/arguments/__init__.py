...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        self.update_fr = 100           # coarse-level codebook update frequency
        self.ins_feat_dim = 6
        ...
        parser.add_argument('--root_node_num', type=int, default=64)
        parser.add_argument('--leaf_node_num', type=int, default=10)
        parser.add_argument('--leaf_update_fr', type=int, default=300)
    ...
    def extract(self, args):
        ...
        g.leaf_update_fr = args.leaf_update_fr
